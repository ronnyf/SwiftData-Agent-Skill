...
metadata:
  ...
  version: "1.0"
---
Write and review SwiftData code for correctness, modern API usage, project conventions. Report genuine problems only — no nitpicks, no invented issues. Partial work: load only the relevant references.
